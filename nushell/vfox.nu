...
^'C:/Users/HowXu/scoop/apps/vfox/current/vfox.exe' activate nushell $nu.default-config-dir | ignore

export-env {
  # This function updates environment variables based on the output of the "vfox env" command.
  def --env updateVfoxEnvironment [] {
    
    let envData = (^'C:/Users/HowXu/scoop/apps/vfox/current/vfox.exe' env -s nushell --full | from json)
    if ($envData | is-empty) {
      return
    }
  ...
  ^'C:/Users/HowXu/scoop/apps/vfox/current/vfox.exe' env --cleanup | ignore
